                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <div class="modal-dialog modal-dialog-centered">
                                        ...
                                        <form action="/Sunday/updateutilisateur.do" method="put">
...
<div class="mb-3"> 
    ...
    <input type="text" class="form-control" id="pwdinput" aria-describedby="pwdhelp" name="pwd" value="<%= o.getPwd() %>"> 
                                ...
                                <td><form action="/Sunday/deleteutilisateur.do" method="delete">
                                    <input type="hidden" name="id" value="<%= o.getId() %>">
        ...
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
            <form action="/Sunday/insertutilisateur.do" method="post">
            <div class="modal-header">
