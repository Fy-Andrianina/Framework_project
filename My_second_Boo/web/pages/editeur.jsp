...
<div class="container-fluid pt-4 px-4">
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <div class="modal-dialog modal-dialog-centered">
                                        ...
                                        <form action="/My_second_Boo/updateediteur.do" method="put">
    ...
    <input type="text" class="form-control" id="labelinput" aria-describedby="labelhelp" name="label" value="<%= o.getLabel() %>"> 
                                ...
                                <td><form action="/My_second_Boo/deleteediteur.do" method="delete">
                                    <input type="hidden" name="id" value="<%= o.getId() %>">
        ...
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
            <form action="/My_second_Boo/insertediteur.do" method="post">
            <div class="modal-header">
