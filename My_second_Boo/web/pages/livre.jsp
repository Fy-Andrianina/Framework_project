                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <div class="modal-dialog modal-dialog-centered">
                                        ...
                                        <form action="/My_second_Boo/updatelivre.do" method="put">
...
<div class="mb-3"> 
    ...
    <input type="date" class="form-control" id="datePublicationinput" aria-describedby="datePublicationhelp" name="datePublication" value="<%= o.getDatePublication() %>"> 
                                ...
                                <td><form action="/My_second_Boo/deletelivre.do" method="delete">
                                    <input type="hidden" name="id" value="<%= o.getId() %>">
        ...
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
            <form action="/My_second_Boo/insertlivre.do" method="post">
            <div class="modal-header">
