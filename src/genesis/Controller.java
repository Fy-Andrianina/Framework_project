...
public class Controller {
    ...
    private HashMap<String, String> controllerChangeInstanciation, controllerWhereInstanciation,
    ...
    private ControllerMethod[] controllerUserMethods;

    public ControllerMethod[] getControllerUserMethods() {
        return controllerUserMethods;
    }

    public void setControllerUserMethods(ControllerMethod[] controllerUserMethods) {
        this.controllerUserMethods = controllerUserMethods;
    }
