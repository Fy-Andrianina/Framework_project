...
<div>
    <SideBar/>
		...
		<td>{{project.label}}</td>
                                  ...
                                  <td>
                                  <router-link :to="`/AuteurEdit/${project.id}`" class="btn btn-success mx-1">Edit</router-link>
		<router-link :to="`/AuteurShow/${project.id}`" class="btn btn-success mx-1">Show</router-link>
