...
<div>
    <SideBar/>
		...
		<td>{{project.label}}</td>
                                  ...
                                  <td>
                                  <router-link :to="`/EditeurEdit/${project.id}`" class="btn btn-success mx-1">Edit</router-link>
		<router-link :to="`/EditeurShow/${project.id}`" class="btn btn-success mx-1">Show</router-link>
